...
def generate_sudoku():
    """ Génère une grille de Sudoku 9x9 valide. """
    base = 3
    side = base * base
...
def remove_values_from_puzzle(grid, percent=0.1):
    """ Enlève un pourcentage spécifié de valeurs d'une grille de Sudoku complète pour créer un puzzle. """
...
def main():
    num_puzzles = 100000  # Nombre de puzzles à générer
